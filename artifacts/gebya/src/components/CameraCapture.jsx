// CameraCapture.jsx — Commit B2
//
// Bug fix: <input capture="environment"> is only a *hint*; many Android
// devices ignore it and open the front camera. This component uses
// getUserMedia with facingMode:'environment' to explicitly request the REAR
